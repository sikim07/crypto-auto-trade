...
/**
 * [v3.11.20260420] EMA21 터치 확인 창/버퍼 제거 — [조건 7] 삭제로 미사용
 *   제거 이유: strategyF.ts [3차 수정] 주석 참조.
 *   터치 윈도우(5봉)가 PROXIMITY(조건 3)와 구조적으로 상충하여 신호 과소 유발.
 */
...
/**
 * [v3.2.20260306] EMA21 기울기 필터 도입 (SLOPE_LOOKBACK, SLOPE_MIN_PCT)
 * [v3.11.20260420] 제거 — [조건 8] 삭제로 미사용
 *   제거 이유: strategyF.ts [3차 수정] 주석 참조.
 *   SLOPE_MIN_PCT=0.01% 임계값이 너무 낮아 실질 차단 효과 없음.
 *   조건 7 제거 후 단독으로 남으면 신호 빈도 감소 부작용만 발생.
 */
